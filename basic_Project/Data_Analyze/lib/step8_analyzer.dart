  ...
  AnalysisResult? runAnalysisProgram(String name, Function functions) {
    ...
    if (manager.datasets.containsKey(name)) {
      ...
      return AnalysisResult(
        dataSet: name,
        functions: functions.runtimeType.toString(), // 함수 타입 저장
...
typedef returnint = int Function(List<int> intList);
...
void printDataContent(DataManager manager, String name){
  manager.printDataset(name);
}
